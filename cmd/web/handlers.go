...
import (
	...
	"github.com/tehweifu/snippetbox/internal/validator"
	"net/http"
	"strconv"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// create!") and teh corresponding key ("flash") to the session data.
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// a UX-nicety (in case the  user makes a type).
	form.CheckField(validator.NotBlank(form.Email), "email", "This field cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email address")
	form.CheckField(validator.NotBlank(form.Password), "password", "This field cannot be blank")
	...
	// User the PopString method to retrieve and remove a value from the session
