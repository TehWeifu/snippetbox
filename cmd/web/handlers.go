...
// Change the signature of the home handler so it is defined as method against
// *application
func (app *application) home(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// use this create a log entry at Error level containing the error
	...
	if err != nil {
		// And we also need to update teh code here to use the structured logger
		// too.
		app.logger.Error(err.Error(), "method", r.Method, "uri", r.URL.RequestURI())
		http.Error(w, "Internal Server Error", http.StatusInternalServerError)
	}
