...
// Define a snippetCreateFrom struct to represent the form data and validation
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// field. Note that we the HTTP status code 422 Unprocessable Entity
	// when sending the response to indicate tht there was a validation error.
	...
	// We also need to update this line to pass the data form the
