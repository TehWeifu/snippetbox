...
import (
	...
	"github.com/tehweifu/snippetbox/internal/models/mocks"
	"html"
	"io"
	"log/slog"
	"net/http"
...
func extractCSRFToken(t *testing.T, body string) string {
	...
	// Note that this returns an array with the entries matched patter in the
	// first position,a nd the values of any captured data in the subsequent
	// positions.
