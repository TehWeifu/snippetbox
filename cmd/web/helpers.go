...
// The client Error helper sends a specific status code and corresponding description
...
// Create an newTemplateData() helper, which returns a template struct
...
func (app *application) decodePostForm(r *http.Request, dst any) error {
	...
	if err != nil {
		// If we to use an invalid target destination, the Decode() method
...
// Return true if the current request if from an authenticated user, otherwise
// return false.
