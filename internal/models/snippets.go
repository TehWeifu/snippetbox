...
// the fields of the struct correspond to the field sin our MySQL snippets
// table?
type Snippet struct {
	ID      int
	Title   string
...
func (m *SnippetModel) Insert(title string, content string, expires int) (int, error) {
	...
	// for readability (which is hy it's surrounded with backquotes instead
...
func (m *SnippetModel) Get(id int) (Snippet, error) {
	...
	// to row.Scan are *pointer* to the place you want to copy the data into,
...
func (m *SnippetModel) Latest() ([]Snippet, error) {
	...
	for rows.Next() {
		...
		// new Snippet object that ew created. Again, the arguments to row.Scan()
